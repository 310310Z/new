(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/[root of the server]__1e218e._.js", {
...
"[project]/lib/supabase.js [client] (ecmascript)": (function(__turbopack_context__) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/lib/supabase.tsx [client] (ecmascript)"); // ここでsupabaseをインポート
;
        ...
        "Home.useEffect": ()=>{
            const fetchData = {
                "Home.useEffect.fetchData": async ()=>{
                    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__["supabase"].from('your_table') // 適切なテーブル名に変更
                    .select('*');
                    if (error) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__1e218e._.js.map