...
"[project]/lib/supabase.js [ssr] (ecmascript)": (function(__turbopack_context__) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$tsx__$5b$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/lib/supabase.tsx [ssr] (ecmascript)"); // ここでsupabaseをインポート
;
;
;
function Home() {
    const [data, setData] = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$__$5b$external$5d$__$28$react$2c$__cjs$29$__["useState"])([]);
    (0, __TURBOPACK__imported__module__$5b$externals$5d2f$__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
        const fetchData = async ()=>{
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$tsx__$5b$ssr$5d$__$28$ecmascript$29$__["supabase"].from('your_table') // 適切なテーブル名に変更
            .select('*');
            if (error) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
        children: [
            ...
            data && data.map((task)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
                    children: task.name
                }, task.id, false, {
                    fileName: "[project]/pages/index.tsx",
                    lineNumber: 28,
                    columnNumber: 9
                }, this) // ここも適切にデータを表示する部分を変更
            )
        ]
    }, void 0, true, {
        fileName: "[project]/pages/index.tsx",
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__f6f8e3._.js.map